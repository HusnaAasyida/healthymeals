...
class CalsCalc extends StatefulWidget {
  final bool isUpdating;

  CalsCalc({@required this.isUpdating});

  @override
  _CalsCalcState createState() => _CalsCalcState();
}

class _CalsCalcState extends State<CalsCalc> {
