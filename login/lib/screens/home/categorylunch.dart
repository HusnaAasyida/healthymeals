...
class CategoryLList extends StatefulWidget {
  @override
  _CategoryLListState createState() => _CategoryLListState();
}

class _CategoryLListState extends State<CategoryLList> {
                    ...
                    child: GridView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return new GestureDetector(
                            ...
                            onTap: () async {
                              await mealProvider.loadMealsByCategory2(
                                  categoryName:
                                      categoryProvider.categories[index].name);
                              changeScreen(
                                  context,
